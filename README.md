...
#2
I think that https://pokerogue.net/ is pretty designed and has some interesting features. Firstly, it is rather faithful to it's source, that being the Pokémon series, in terms of the Pokémon themselves, the characters, the moves that you use, and so on. Additionally, it also has a gacha system, which isn't that great, but it is pretty cool that it can generate multiple random values and assign them really effectively. 
